      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0 col justify-content-center">
            <li className="nav-item mx-2 ms-4 ">{props.active==false?<Link className="nav-link" to="/">Home</Link>:<Link className="nav-link fw-bold" to="/">Home</Link>}</li>
            <li className="nav-item mx-2 ms-4">{props.active==false?<Link className="nav-link fw-bold" to="/about">About</Link>:<Link className="nav-link" to="/about">About</Link>}</li>
          </ul>
